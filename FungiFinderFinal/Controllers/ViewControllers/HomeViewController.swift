...
class HomeViewController: UIViewController {
    ...
    Never eat any mushroom without the help of a professional. Some mushrooms may be tasty, but plenty can be deadly. While Fungi Finder can be used as a supplimental source for educational identificaiton, judgement should never be decided based on one source alone.
    """
    ...
    func displayLicenAgreement(message:String){
        ...
        let acceptAction = UIAlertAction(title: "I Understand", style: .default) { (action) -> Void in
        }
